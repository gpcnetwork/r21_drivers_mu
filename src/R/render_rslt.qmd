...
The table below reports column-wise (col_p1,col_p0) and row-wise (row_p1, row_p0) percentages stratified SMM status, \`SMMANY_IND\`:
...
## Multiple Lasso Regression Coefficients
